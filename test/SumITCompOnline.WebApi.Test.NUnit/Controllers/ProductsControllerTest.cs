...
namespace SumITCompOnline.WebApi.Test.Controllers
{
    ...
    public class ProductsControllerTest
    {
        ...
        [Test]
        public void PutProduct_Quantity_ShouldReturnStatusCode()
        {
            // Arrange
            ...
            // Act
            var result = controller.PutProductQuantity(1, quantity) as StatusCodeResult;
        ...
        public void PutProduct_ShouldFail_WhenDifferentID()
        {
            ...
            Assert.IsInstanceOfType(typeof(BadRequestErrorMessageResult),badresult);
